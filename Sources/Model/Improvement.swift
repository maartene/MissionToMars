...
public struct Improvement: Codable, Equatable {
    ...
    public static let allImprovements = [
        ...
        Improvement(shortName: .SpaceTourism, name: "Space Tourism Agency", description: "Allow the rich the opportunity to look at Earth from Space! As you are piggy backing on your existing technology, this is a very cost effective way of generating some extra income (+1k)", cost: 100_000, buildTime: 365 / 12, requiredTechnologyShortnames: []),
