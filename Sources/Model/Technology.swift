...
public struct Technology: Equatable, Codable {
    ...
    public static let allTechnologies = [
        ...
        Technology(shortName: .FuelConservation_2, name: "Fuel Conservation 1", description: "Further improvements in fuel efficiency are required to asprire to make the trip to Mars and back.", cost: 150, prerequisites: [.FuelConservation_1]),
        ...
        Technology(shortName: .GrapheneBatteries, name: "Graphene Solar Cells", description: "The first major improvement to battery technology after LiIon.", cost: 800, prerequisites: [.GrapheneMaterials]),
