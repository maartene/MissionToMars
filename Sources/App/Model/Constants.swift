...
public let UPDATE_INTERVAL_IN_MINUTES = 5.0
//public let UPDATE_INTERVAL_IN_MINUTES = 0.05
public let MAXIMUM_PLAYER_ACTION_POINTS = 10
public let TECH_EXTRA_MAXIMUM_PLAYER_ACTION_POINTS = 10
public let BASE_PLAYER_SPECILIAZATION_SLOTS = 0
