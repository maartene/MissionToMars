...
public struct Component: Equatable, Codable {
    ...
    public static let allComponents: [Component] = [
        ...
        Component(shortName: .SolarPanel, name: "Solar Panel Array", description: "Power is essential to operate any equipment on Mars. These panels come with ample batteries.", cost: 250_000_000, buildTime: 365 / 2, requiredTechnologyShortnames: [.GrapheneSolarCells]),
        ...
        Component(shortName: .Supplies, name: "Supplies", description: "With the complexity of all the other parts, ammassing the required supplies is actually unexpectatly easy (and cheap)", cost: 10_000_000, buildTime: 365 / 4, requiredTechnologyShortnames: [.PackageOptimization]),
        Component(shortName: .Habitat, name: "Dome based habitat", description: "The Dome will be the colonies primary habitat. Initially it's only ferried to Mars, it will be setup on a suitable location by the first group of colonists.", cost: 10_000_000, buildTime: 365 / 4, requiredTechnologyShortnames: [.RadiationShielding]),
