...
public struct Improvement: Codable, Equatable, Effector {
    ...
    public static let allImprovements = [
        // Start improvements
        Improvement(shortName: .TechConsultancy, name: "Technology Consultancy firm", description: "This firm provides a great versetile start if you don't want to commit to money making or researching new technologies. Good fit if you want to go solo, but in the long run specializing might be more attractive.", cost: 0, buildTime: 365 / 6, updateEffects: [.extraImprovementSlots(amount: 4)], activatedAbilities: [ActivatedAbility(name: "tc_cashAndTech", effects: [.extraIncomeFlat(amount: 6500), .extraTechFlat(amount: 2)], cooldown: 60)], tags: [.AI, .SpaceTravel]),
        Improvement(shortName: .Faculty, name: "Faculty of Applied Sciences", description: "You start with a faculty on a prestigious University and assure yourself of a steady supply of extra technology points and a little income.", cost: 0, buildTime: 365 / 12, updateEffects: [.extraImprovementSlots(amount: 5)], activatedAbilities: [ActivatedAbility(name: "foas_tech", effects: [.extraTechFlat(amount: 15), .extraIncomeFlat(amount: 1000)], cooldown: 60)], tags: [.Biotech, .AI, .SpaceTravel]),
        Improvement(shortName: .InvestmentBank, name: "Investment Bank", description: "If you want to make it rain (become very VERY rich), starting an investment bank is a great start. The bank provides extra income as well as ROI on your outstanding balance. However, it doesn't generate any technology. You will need to find other ways if you want to advance the tech tree.", cost: 0, buildTime: 365 / 12, updateEffects: [.extraImprovementSlots(amount: 5)], activatedAbilities: [ActivatedAbility(name: "ib_cash", effects: [.extraIncomeFlat(amount: 15_000)], cooldown: 60), ActivatedAbility(name: "ib_interestCash", effects: [.interestOnCash(percentage: 0.5)], cooldown: 60*60*24)], tags: [.Finance]),
