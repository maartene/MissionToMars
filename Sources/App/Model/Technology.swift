...
public struct Technology: Equatable, Codable, Effector {
    ...
    public static let allTechnologies = [
        ...
        Technology(shortName: .ScaledAgileLeadership, name: "Scaled Agile Leadership", description: "Scaling your agile practives to enterprise level increases the maximum output your enterprises can create.", cost: 600, updateEffects: [], prerequisites: [.AgileLeadership]),
